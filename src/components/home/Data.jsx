...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title"> Iyed Limem
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">
                Meticulous Full Stack Engineer looking to apply my expertise. 
                Have a look into my portfolio I may be your next front/back-end engineer.
            </p>
